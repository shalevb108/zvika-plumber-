...
const defaults: FaqItem[] = [
  ...
  { _id: '8', question: 'מה עושים במקרה של נזילה חירום?', answer: 'סגרו את ברז הראשי לפני שמתקשרים. תמצאו אותו בדרך כלל בכניסה לבית. לאחר מכן התקשרו ל-050-1234567 ונגיע מהר ככל האפשר.', category: 'חירום', order: 8, active: true },
];
